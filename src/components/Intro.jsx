...
const Intro = forwardRef(( props, ref ) => {
    ...
    return (
      <div ref={ref} className='div_intro'>
        <h2>Venta de Las Galletas Checas de Navidad</h2>
        ...
        <p>Más informaciónes y posibles pedidos a través de <b>WhatsApp: +420 732 964 320.</b></p>
  
        <h4>El paquete (ver en la foto abajo) contiene varias galletas checas de Navidad con los siguientes ingredientes y cuesta 500 MXN/ aprox. 300 g:</h4>
      </div>
    )
  });
